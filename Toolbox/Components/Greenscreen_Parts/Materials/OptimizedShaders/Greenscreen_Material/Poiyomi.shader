Shader "Hidden/Locked/.poiyomi/Old Versions/8.0/Poiyomi Toon/197310dc554f8524dbb53d65c29c29a2"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((0.0 /*_LightingColorMode*/) == 3)
				{
					...
					poiLight.indirectColor = max(poiLight.indirectColor, (1.0 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor = max(poiLight.directColor, poiLight.directColor / max(0.0001, (calculateluminance(poiLight.directColor) / (1.0 /*_LightingMinLightBrightness*/))));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor / max(0.0001, (calculateluminance(poiLight.indirectColor) / (1.0 /*_LightingMinLightBrightness*/))));
				}
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0,1,0,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0,1,0,1).a;
